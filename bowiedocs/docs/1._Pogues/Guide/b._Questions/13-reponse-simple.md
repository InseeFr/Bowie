...
!!! info
    ...
    - Pour gérer un champ Date vide il suffit d'utiliser [isnull()](../../VTL/1-fonctions-vtl.md/#isnull)
        ```
        isnull($DATE$)
        ```
...
!!! warning "Type d'une point de vue VTL"
    - D'un point de vue Pogues, on parle bien d'un type *Date*, mais d'un point de vue VTL, une variable de type *Date* va en réalité être collectée en tant que **texte** sous l'un des formats cités plus haut.
        ...
        C'est pourquoi il est nécessaire de transtyper en utilisant la fonction [cast()](../../VTL/1-fonctions-vtl.md/#cast) ces variables en `date` pour les comparer. Voir [exemple d'utilisation](../../VTL/1-fonctions-vtl.md/#__tabbed_5_3)
...
!!! info
    ...
    - Pour gérer un champ Nombre vide il suffit d'utiliser [isnull()](../../VTL/1-fonctions-vtl.md/#isnull)
        ```
        isnull($NOMBRE$)
        ```
...
!!! info
    ...
    - Pour gérer un champ Durée vide il suffit d'utiliser [isnull()](../../VTL/1-fonctions-vtl.md/#isnull)
        ```
        isnull($DUREE$)
        ```