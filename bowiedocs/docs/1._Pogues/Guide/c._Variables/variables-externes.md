...
!!! danger 
    ...
    **Impact :** si ces variables doivent être utilisées comme des nombres, il faut alors passer par une variable calculée avec le bon type et utiliser la fonction [cast()](../../VTL/1-fonctions-vtl.md/#cast) et quel :
