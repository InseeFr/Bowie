...
!!!note
    ...
    À partir de cette section, il est utile de s'être familiarisé avec VTL en parcourant [le guide dédié](../VTL/index.md) et le consultant régulièrement.
...
!!! abstract "Pour aller plus loin"
    ...
    - __[Les filtres :material-arrow-right-bold-box-outline:](../Guide/a._Questionnaire/25-filtres.md)__
