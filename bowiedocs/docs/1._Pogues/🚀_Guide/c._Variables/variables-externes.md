...
!!! danger 
    ...
    **Impact :** si ces variables doivent être utilisées comme des nombres, il faut alors passer par une variable calculée avec le bon type et utiliser la fonction [cast()](../../💻_VTL/1-fonctions-vtl.md/#cast) et quel :
...
!!! abstract "Nouvelle variable externe"
    ...
    1. `Niveau de calcul*` : correspond à la portée de la variable. Plus de détails [ici](https://inseefr.github.io/Bowie/1._Pogues/%F0%9F%9A%80_Guide/c._Variables/portee/)
...
Il faudra ensuite fournir à l'intégration un fichier CSV contenant les variables et valeurs ad hoc (voir [ici](../d._Personnalisation/2-guide-perso-echantillon.md#variables-externes-de-portee-boucle-ou-tableau-dynamique), section "Variables de portée Boucle")
