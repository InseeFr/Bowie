# Spécifier une liste de codes (Old ⚠️)

!!! danger "Bientôt déprécié"
    Suite à la nouvelle interface de Pogues, cette page ne sera plus mise à jour et sera bientôt supprimé


On peut mobiliser ces listes de 3 manières  :
