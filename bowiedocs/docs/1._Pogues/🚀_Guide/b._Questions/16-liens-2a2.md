...
La variable source du sexe n'est pas un attribut à renseigner obligatoirement pour faire fonctionner la question de type liens deux à deux. Toutefois, elle est indispensable pour accéder aux [variables globales décrivant les parents, enfants et conjoints](../c._Variables/variables-globales.md#variables-globales-issues-des-liens-deux-a-deux). 
...
!!!abstract "Pour aller plus loin"
    [Les variables globales issues des liens deux à deux](../c._Variables/variables-globales.md#variables-globales-issues-des-liens-deux-a-deux)