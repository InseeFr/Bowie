# Utilisation de nomenclatures dans Pogues

Les nomenclatures sont utilisées comme données d'entrées dans le composant de recherche sur liste (ou "Suggester") de Pogues. Plus de détails dans [la page dédié](suggester.md)

Les nomenclatures pour être utilisable par ce composant doivent contenir au moins les attributs/colonnes `id` et `label`.
