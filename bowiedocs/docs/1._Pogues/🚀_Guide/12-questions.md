...
!!! tip 
Dans le cas où la question correspond à une seule réponse et donc à une seule variable collectée, l'identifiant métier de la variable collectée semble la meilleure option. Voir également : [le nommage des variables](./Variables/nommage.md)>
