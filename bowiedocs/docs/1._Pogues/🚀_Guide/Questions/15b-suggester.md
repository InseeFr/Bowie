...
Pour référence, un [questionnaire implémentant cette solution :material-open-in-new:](https://conception-questionnaires.insee.fr/questionnaire/m1holrzlDOC){target="_blank"} est disponible dans l'environnement de demo, sous le timbre DOCUMENTATION
