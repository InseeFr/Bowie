...
Depuis l'été 2026, tous les utilisateurs utilisent la même [plateforme](https://conception-questionnaires.insee.fr/) pour accéder aux services de conception de questionnaires.
...
Après habilitation par l'atelier de conception, il suffit d'utiliser [l'url de l'application](https://conception-questionnaires.insee.fr/). L'authenfication se fait automatiquement via ProConnect sinon vous pouvez utiliser le bouton `Cliquez ici pour une connexion depuis un pc Insee`.

## Connexion pour un utilisateur SSM ou statistique publique

Lors de votre première connexion depuis [l’url de l’application](https://conception-questionnaires.insee.fr/), pensez bien à utiliser **le bouton « S'identifier avec ProConnect »** avant de saisir votre identifiant / mot de passe, la connexion directe avec identifiant  / mot de passe est inopérante.
...
![Utilisateur authenfié mais non habilité](../../img/pogues/erreur403-pogues.png)
