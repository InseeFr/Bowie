...
??? success "Solution"
    ...
    ![Création PRENOMLIB](../../img/pogues/creation-prenomlib.png)

## Personnalisation du libellé de la question `APPRECIATION`

On peut retourner sur la question dont l'identifiant est `APPRECIATION`, pour modifier son libellé de manière à commencer par le texte produit par la variable `PRENOMLIB`.
