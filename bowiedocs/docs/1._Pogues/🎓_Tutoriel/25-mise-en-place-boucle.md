...
Vous pouvez comparer votre création avec le [corrigé de l'exercice :material-open-in-new:](https://conception-questionnaires-demo.insee.fr/Questionaire/ml82b1lb){target="_blank"}.
