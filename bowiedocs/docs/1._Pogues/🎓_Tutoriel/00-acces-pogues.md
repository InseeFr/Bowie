...
Depuis l'été 2026, tous les utilisateurs utilisent la même [plateforme :material-open-in-new:](https://conception-questionnaires.insee.fr/){target="_blank"} pour accéder aux services de conception de questionnaires.
...
Après habilitation par l'atelier de conception, il suffit d'utiliser [l'url de l'application :material-open-in-new:](https://conception-questionnaires.insee.fr/){target="_blank"}. L'authenfication se fait automatiquement via ProConnect sinon vous pouvez utiliser le bouton `Cliquez ici pour une connexion depuis un pc Insee`.
