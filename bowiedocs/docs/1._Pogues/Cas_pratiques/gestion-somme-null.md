...
!!! warning "Attention"
    ...
    Voir [le type nombre](../🚀_Guide/b._Questions/13-reponse-simple.md#type-de-reponse-nombre) pour plus de détail.
...
!!! tips "Info"
    Voir **[portée des variables](../🚀_Guide/c._Variables/portee.md)** pour plus de détails sur comment utilisé le niveau de calcul

## Questionnaire exemple

Pour référence, un [questionnaire implémentant cette solution :material-open-in-new:](https://conception-questionnaires-demo.insee.fr/a._Questionaire/m2iwuqca){target="_blank"} est disponible dans l'environnement de demo, sous le timbre DOCUMENTATION